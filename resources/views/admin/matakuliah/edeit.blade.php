...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4><i class="bi bi-book"></i> Edit Mata Kuliah</h4>
    ...
    <div class="card-body">
        <form action="{{ route('admin.matakuliah.update', $matakuliah->kode_matakuliah) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_matakuliah" class="form-control @error('nama_matakuliah') is-invalid @enderror" value="{{ old('nama_matakuliah', $matakuliah->nama_matakuliah) }}" placeholder="Masukkan Nama Mata Kuliah">
